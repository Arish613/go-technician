...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333333; margin: 0; padding: 0; background-color: #f4f4f4;">
                    ...
                    <tr>
                        <td style="padding: 30px 25px;">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="font-size: 14px;">
                                ...
                                <tr>
                                    <td style="padding: 8px 0; border-bottom: 1px dashed #e9ecef; width: 40%; font-weight: bold; color: #555555;">
                                        Name:
                                    </td>
                                ...
                                <tr>
                                    <td style="padding: 8px 0; width: 40%; font-weight: bold; color: #555555;">
                                        Description:
                                    </td>
                                    <td style="padding: 8px 0; width: 60%; color: #333333; word-break: break-all;">
    ...
    // console.log("Receiver mail", receiverEmail);

    sendSmtpEmail.subject = "Go Technicians Support";
